...
} # Cases Master File
{
  ...
  scdb_cases <- get(load('Stat Reviews/OT25_StatReview/decisions/data/scdb_cases_2025.rdata'))
  scdb_justices <- get(load('Stat Reviews/OT25_StatReview/decisions/data/scdb_justices_2025.rdata'))
