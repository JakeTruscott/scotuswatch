...
To maintain methodological consistency, we code choices to join the \textbf{Minority} (\emph{Dissent}) as instances where a Justice (1) Authored a Dissenting Opinion or (2) \textbf{Only} Joined a Dissenting Opinion. \\
...
\noindent During the 2024 term, nine orally argued and decided cases represent consolidated petitions. However, only one case was consolidated and represented a petitions emerging from different courts below. We indicate the distinction below. \\

\begin{itemize}

\item \emph{Hewitt v. United States} \& \emph{Duffey v. United States} (CA5)
\item \emph{CC/Devas v. Antrix Corp.} \& \emph{Devas Multimedia v. Antrix} (CA9)
\item \emph{NRC v. Texas} \& \emph{Interim Storage Partners v. Texas} (CA5)
\item \emph{Lousiana v. Callais} \& \emph{Robinson v. Callais} (WDLA)
\item \emph{Oklahoma v. EPA} \& \emph{Pacificorp v. EPA} (CA10)
\item \emph{FCC v. Consumers' Research} \& \emph{SHLB Coalition v. Consumers' Reserch} (CA2)
\item \emph{OK Charter School Board v. Drummond} \& \emph{St. Isidore of Seville Sch. v. Drummond} (SCOK)
\item \emph{Trump v. CASA Inc.} \& \emph{Trump v. Washington} \& \emph{Trump v. New Jersey} (CA4, CA9, and CA1)
