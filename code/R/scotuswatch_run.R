...
for (i in 1:length(unique_sittings)){
  ...
  temp_output_name <- paste0('OT_25_', temp_sitting) # Create Output Name
...
scotusblog_run <- scotusblog_stats(decisions_path <- "C:/Users/jaketruscott/Github/scotuswatch/Stat Reviews/OT24_StatReview/decisions/data/OT_24_Decisions.csv",
